...
context PDF::Reader::XRef, "load_offsets method" do
...
context PDF::Reader::XRef, "when operating on a pdf with no trailer" do
...
context PDF::Reader::XRef, "when operating on a pdf with a trailer that isn't a dict" do
...
context PDF::Reader::XRef, "when operating on a pdf that uses an XRef Stream" do
