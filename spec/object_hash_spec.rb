...
describe Marron::ObjectHash do
  ...
  it "should raise an ArgumentError if passed a non filename and non IO" do
    filename = pdf_spec_file("cairo-unicode")
     lambda {Marron::ObjectHash.new(10)}.should raise_error(ArgumentError)
  end

end

describe Marron::ObjectHash, "[] method" do
...
describe Marron::ObjectHash, "object method" do
  ...
  it "should translate reference objects into an extracted PDF object" do
    ...
    h.object(Marron::Reference.new(3,0)).should eql(3649)
  end
end

describe Marron::ObjectHash, "deref! method" do
  ...
  it "should translate reference objects into an extracted PDF object" do
    hash.deref!(Marron::Reference.new(3,0)).should eq 3649
  end
...
describe Marron::ObjectHash, "fetch method" do
  ...
  it "should correctly extract an int object using Marron::Reference keys" do
    filename = pdf_spec_file("cairo-unicode")
    h = Marron::ObjectHash.new(filename)
    ref = Marron::Reference.new(3,0)
...
describe Marron::ObjectHash, "each method" do
  ...
  it "should provide a Marron::Reference to each iteration" do
    filename = pdf_spec_file("cairo-unicode")
    h = Marron::ObjectHash.new(filename)

    h.each do |id, obj|
      id.should be_a_kind_of(Marron::Reference)
      obj.should_not be_nil
    end
  end
end

describe Marron::ObjectHash, "each_key method" do
  ...
  it "should provide a Marron::Reference to each iteration" do
    ...
    h.each_key do |ref|
      ref.should be_a_kind_of(Marron::Reference)
    end
  end
end

describe Marron::ObjectHash, "each_value method" do
...
describe Marron::ObjectHash, "size method" do
...
describe Marron::ObjectHash, "empty? method" do
...
describe Marron::ObjectHash, "has_key? method" do
  ...
  it "should return true when called with a valid ID" do
    ...
    h.has_key?(Marron::Reference.new(1,0)).should be_true
  end
  ...
  it "should return false when called with an invalid ID" do
    ...
    h.has_key?(Marron::Reference.new(10000,0)).should be_false
  end
end

describe Marron::ObjectHash, "has_value? method" do
...
describe Marron::ObjectHash, "keys method" do
  ...
  it "should return an array of keys" do
    ...
    keys.each { |k| k.should be_a_kind_of(Marron::Reference) }
  end
end

describe Marron::ObjectHash, "values method" do
...
describe Marron::ObjectHash, "values_at method" do
...
describe Marron::ObjectHash, "to_a method" do
...
describe Marron::ObjectHash, "trailer method" do
  ...
  it "should return the document trailer dictionary" do
    ...
    expected = {:Size => 58,
                :Root => Marron::Reference.new(57,0),
                :Info => Marron::Reference.new(56,0)}
    h.trailer[:Size].should eql(58)
    h.trailer[:Root].should eql(Marron::Reference.new(57,0))
    h.trailer[:Info].should eql(Marron::Reference.new(56,0))
  end
end

describe Marron::ObjectHash, "pdf_version method" do
...
describe Marron::ObjectHash, "page_references method" do
